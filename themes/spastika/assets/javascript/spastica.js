                ...
                $('#doctor-details').animate({
                    ...
                    $('#doctor-details').hide(500, function() {
                        ...
                        $('#doctor-details').append(
                            ...
                            doctor.main.name + "</h5>" + doctor.main.position + "<br /><strong>" + doctor.assistant.clinic_name + "</strong><br />" + doctor.assistant.clinic_address + "</div>" + assistantDetails +
        ...
        $('#doctor-result').animate({
            ...
            $('#doctor-result').hide(50, function() {
                ...
                if ($currentSelectedRegionDoctors.length > 0) {
                    ...
                    console.log($('#doctor-result').width() - 120 - doctorCount * 154);
