                ...
                $('#doctor-details').animate({
                    ...
                    $('#doctor-details').hide(500, function() {
                        ...
                        $('#doctor-details').append(
                            ...
                            "</div><div class='col-6'><a href='" + rootPath + "/ru/apply?doctor-id=" + doctorId + "' class='btn btn-primary' role='button'>Записатися</a></div><div class='col-6'><a href='" + rootPath + "/themes/spastika/assets/images/upload/ukr_spastika.png' class='btn btn-primary brochure-button' onclick=\"ga('send', 'event', 'button_spastika','click','buklet_spastika');\" role='button'target='_blank' download=''>Завантажити брошуру</a></div></div></div>");
                        $('#doctor-details').show();
                        $('#doctor-details').animate({
                            "opacity": '1',
