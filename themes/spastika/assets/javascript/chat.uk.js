(function() {
    ...
    var defaultAnswer = 'Проект SPASTICA - інформаційний ресурс про реабілітацію пацієнтів, які перенесли інсульт. Ми інформуємо про сучасні підходи і допомагаємо пацієнтам записатися на консультацію до профільних фахівців. Додатково на нашому веб-сайті ви можете скачати брошуру з інформацією про сучасні підходи реабілітації для пацієнтів, які перенесли інсульт';

    // Insult
    var insultWelcome = 'Добрий день, я - ваш віртуальний помічник. Проект SPASTICA - інформаційний ресурс про реабілітацію пацієнтів, які перенесли інсульт. Ми інформуємо про сучасні підходи і допомагаємо пацієнтам записатися на консультацію до профільних фахівців. Додатково на нашому веб-сайті ви можете скачати брошуру з інформацією про сучасні підходи реабілітації для пацієнтів, які перенесли інсульт.';
    var insultEffects = "Поширені ускладнення після інсульту - поріз, розвиток м'язової спастичності і поява контрактури, які заважають відновленню рухової функції. Більш детальну інформацію з цього питання Ви зможете дізнатися з розділів <a class='simple-link' href='" + rootPath + "/uk/spastika'>Спастичність</a> і <a class='simple-link' href='" + rootPath + "/uk/reabilitation'>Реабілітація</a> після інсульту";
    var insultTherapy = "<a class='simple-link' href='" + rootPath + "/uk/spastika'>Дізнатися детальніше про спастичності і її причини</a><br /><a class='simple-link' href='" + rootPath + "/uk/reabilitation'>Дізнатися детальніше про реабілітацію після інсульту</a>";
    ...
    // Spastika
    var spastikaPercent = 'Зміна положення руки це зміна положення руки.';
    var spastikaWelcome = "Добрий день, я - ваш віртуальний помічник. Проект SPASTICA - інформаційний ресурс про реабілітацію пацієнтів, які перенесли інсульт. Ми інформуємо про сучасні підходи і допомагаємо пацієнтам записатися на консультацію до профільних фахівців. Додатково на нашому веб-сайті ви можете скачати брошуру з інформацією про сучасні підходи реабілітації для пацієнтів, які перенесли інсульт. <br/> Спастичність - це патологічна напруга м'язів, яка викликає контрактури - зміни в м'язах, сухожиллях і суглобі.";
    var spastikaWelcomeElse = "Спастичність - це патологічна напруга м'язів, яка викликає контрактури - зміни в м'язах, сухожиллях і суглобі.";
    var spastikaHands = "Для різних видів спастичності використовуються різні види терапії. Більш детальну інформацію Ви можете дізнатися нижче в розділі Види спастичності";
    var modernDeseases = "Сучасні методи терапії і реабілітації після інсульту дозволяють зменшити спастичність, щоб сконцентрувати зусилля на відновленні рухової функції. Вибір конкретного виду терапії залежить від виду спастичності у пацієнта. Більш детальна інформація наведена в розділі Види спастичності.";
    ...
    // Reabilitation
    var reabilitationWelcome = 'Добрий день, я - ваш віртуальний помічник. Проект SPASTICA - інформаційний ресурс про реабілітацію пацієнтів, які перенесли інсульт. Ми інформуємо про сучасні підходи і допомагаємо пацієнтам записатися на консультацію до профільних фахівців. Додатково на нашому веб-сайті ви можете скачати брошуру з інформацією про сучасні підходи реабілітації для пацієнтів, які перенесли інсульт.<br />Розділ «Реабілітація» містить інформацію про сучасні підходи реабілітації пацієнтів після інсульту.';
    var reabilitationWelcomeElse = 'Розділ «Реабілітація» містить інформацію про сучасні підходи реабілітації пацієнтів після інсульту.';
    ...
    function typeBotMessage(request) {
        ...
        setTimeout(function() {
            $('.message.loading').remove();
            $('<div class="message new"><figure class="avatar"><img src="data:image/png;base64," /></figure>' + generateBotMessage(request) + '</div>').appendTo($('.mCSB_container')).addClass('new');
            setDate();
            updateScrollbar();
        }, 1000 + (Math.random() * 20) * 100);
