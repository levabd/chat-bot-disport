(function() {
    ...
    var insultEffects = "Распространенные осложнения после инсульта – порез, развитие мышечной спастичности и появление контрактуры, которые мешают восстановлению двигательной функции. Более подробную информацию по этому вопросу мы сможете узнать из разделов <a class='simple-link' href='" + rootPath + "/ru/spastika'>Спастичность</a> и <a class='simple-link' href='" + rootPath + "/ru/reabilitation'>Реабилитация</a> после инсульта";
