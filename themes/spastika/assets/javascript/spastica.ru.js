                ...
                $('#doctor-details').animate({
                    ...
                    $('#doctor-details').hide(500, function() {
                        ...
                        $('#doctor-details').append(
                            ...
                            "</div><div class='col-6'><a href='" + rootPath + "/ru/apply?doctor-id=" + doctorId + "' class='btn btn-primary' role='button'>Записаться</a></div><div class='col-6'><a href='#' class='btn btn-primary brochure-button' role='button'>Скачать брошюру</a></div></div></div>");
                        $('#doctor-details').show();
                        $('#doctor-details').animate({
                            "opacity": '1',
